        ...
        <div className="space-y-4">
            {groupedMethods.map((group, i) => (
                <Disclosure key={i} as="div" className="mb-2">
                    {() => (
                        <>
                            <DisclosureButton className="flex justify-between w-full bg-gray-800 text-white px-4 py-2 rounded-md">
                                {({ open }) => (
                                    <>
                            ...
                            <DisclosurePanel className="grid grid-cols-2 gap-2 mt-2">
