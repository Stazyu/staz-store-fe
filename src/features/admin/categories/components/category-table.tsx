...
import { 
    ...
    FiSearch, FiActivity, FiZap
} from "react-icons/fi";
import { 
    BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, 
    ResponsiveContainer
} from "recharts";
import { fetchCategories, deleteCategory } from "@/services/category.client";
...
export default function CategoryTable() {
    ...
    // Fetch Categories
    const { data: categories = [], isLoading, error, isFetching } = useQuery({
                ...
                <div className="relative flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    <div>
                        <div className="flex items-center gap-3 mb-3">
                            <LiveDot />
                            <span className="text-xs font-semibold text-emerald-600 dark:text-emerald-400 uppercase tracking-widest">Management</span>
                        </div>
