                      ...
                      <TableRow key={inv.id} className="border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                        ...
                        <TableCell>
                          <span className={`inline-flex items-center px-1.5 py-0.5 rounded text-xs font-medium ${
                            inv.topUpChannel === "TELEGRAM"
                              ? "bg-sky-50 dark:bg-sky-950/35 text-sky-700 dark:text-sky-400 border border-sky-100 dark:border-sky-900/30"
                              : "bg-indigo-50 dark:bg-indigo-950/35 text-indigo-700 dark:text-indigo-400 border border-indigo-100 dark:border-indigo-900/30"
                          }`}>
                            {inv.topUpChannel || "WEB"}
                          </span>
                        </TableCell>
                        <TableCell>
                  ...
                  <div>
                    ...
                    <p className="font-medium">
                      <span className={`inline-flex items-center px-1.5 py-0.5 rounded text-xs font-semibold ${
                        detailInv.topUpChannel === "TELEGRAM"
                          ? "bg-sky-50 dark:bg-sky-950/35 text-sky-700 dark:text-sky-400 border border-sky-100 dark:border-sky-900/30"
                          : "bg-indigo-50 dark:bg-indigo-950/35 text-indigo-700 dark:text-indigo-400 border border-indigo-100 dark:border-indigo-900/30"
                      }`}>
                        {detailInv.topUpChannel || "WEB"}
                      </span>
                    </p>
                  </div>
                </div>
